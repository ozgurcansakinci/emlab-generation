...
public class Interconnector {
    ...
    private HourlyVariableTimeSeries interconnectorFlowFromAtoB;

    private HourlyVariableTimeSeries interconnectorFlowFromBtoA;

    public HourlyVariableTimeSeries getInterconnectorFlowFromAtoB() {
        return interconnectorFlowFromAtoB;
    }

    public void setInterconnectorFlowFromAtoB(HourlyVariableTimeSeries interconnectorFlowFromAtoB) {
        this.interconnectorFlowFromAtoB = interconnectorFlowFromAtoB;
    }

    public HourlyVariableTimeSeries getInterconnectorFlowFromBtoA() {
        return interconnectorFlowFromBtoA;
    }

    public void setInterconnectorFlowFromBtoA(HourlyVariableTimeSeries interconnectorFlowFromBtoA) {
