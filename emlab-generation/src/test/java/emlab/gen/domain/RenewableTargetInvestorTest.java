...
public class RenewableTargetInvestorTest {
    ...
    public void testBasicFunctions() {
        ...
        Set<PowerGeneratingTechnologyTarget> targetsFromDb = template.findAll(TargetInvestor.class).iterator().next()
                .getPowerGenerationTechnologyTargets();
    ...
    public void testEnergyProducerAndRenewableTargetInvestorQueries() {
        ...
        List<EnergyProducer> energyProducers = energyProducerRepository
