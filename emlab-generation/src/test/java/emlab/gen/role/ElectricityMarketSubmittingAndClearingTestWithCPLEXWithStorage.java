...
@Transactional
public class ElectricityMarketSubmittingAndClearingTestWithCPLEXWithStorage {

    Logger logger = Logger.getLogger(ElectricityMarketSubmittingAndClearingTestWithCPLEXWithStorage.class);
    ...
    public void setUp() throws Exception {
        ...
        market1.setStorageImplemented(true);
        ...
        market2.setStorageImplemented(true);
