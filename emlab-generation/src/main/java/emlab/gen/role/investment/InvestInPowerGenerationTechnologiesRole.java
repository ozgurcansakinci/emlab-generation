            ...
            if ((expectedInstalledCapacityOfTechnology + plant.getActualNominalCapacity())
                ...
                if (runningHours < plant.getTechnology().getMinimumRunningHours()) {
                    ...
                    if ((agent.isSimpleCapacityMarketEnabled()) && (regulator != null)) {
                        ...
                        if ((totalPeakCapacityAtFuturePoint > (totalPeakDemandAtFuturePoint
                                * (1 + (regulator.getReserveMargin() - regulator.getReserveDemandLowerMargin())))
                                && totalPeakCapacityAtFuturePoint <= (totalPeakDemandAtFuturePoint * (1
                                        + (regulator.getReserveMargin() + regulator.getReserveDemandUpperMargin()))))) {
                        ...
                        if (totalPeakCapacityAtFuturePoint > (totalPeakDemandAtFuturePoint
                                * (1 + (regulator.getReserveMargin() + regulator.getReserveDemandUpperMargin())))) {
                            capacityRevenue = 0;
