 ...
 */
@RoleComponent
public class ReceiveLongTermContractPowerRevenuesRole extends AbstractEnergyProducerRole
    ...
    public void act(EnergyProducer producer) {
        ...
        for (Segment segment : reps.genericRepository.findAll(Segment.class)) {
            for (LongTermContract longTermContract : reps.contractRepository
                ...
                double basePrice = longTermContract.getCapacity() * longTermContract.getPricePerUnit()
                ...
                reps.nonTransactionalCreateRepository.createCashFlow(longTermContract.getTo(),
                        longTermContract.getFrom(), updatedPrice, CashFlow.ELECTRICITY_LONGTERM, getCurrentTick(),
                        null);
        ...
        // double price = 0d;
        // for (ClearingPoint point :
        // reps.clearingPointRepositoryOld.findClearingPointsForSegmentAndTime(plan.getSegment(),
        // getCurrentTick())) {
        ...
        // reps.nonTransactionalCreateRepository.createCashFlow(plan.getBiddingMarket(),
        // plan.getBidder(), plan.getAcceptedAmount()
        // * plan.getSegment().getLengthInHours() * price,
