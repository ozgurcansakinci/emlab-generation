 ...
 */
@RoleComponent
public class SubmitBidsToCommodityMarketAnnualRole extends AbstractEnergyProducerRole implements Role<EnergyProducer> {
    ...
    public void act(EnergyProducer producer) {
        ...
        for (PowerPlant plant : reps.powerPlantRepository.findOperationalPowerPlantsByOwner(producer,
            ...
            // double totalSupply =
            // plant.calculateElectricityOutputAtTime(getCurrentTick(), false);
            double totalSupply = reps.ppdpAnnualRepository.findPPDPAnnualforPlantForCurrentTick(plant, getCurrentTick())
                    .getYearlySupply();
