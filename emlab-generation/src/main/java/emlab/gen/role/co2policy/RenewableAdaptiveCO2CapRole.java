...
public class RenewableAdaptiveCO2CapRole extends AbstractRole<Government> {
    ...
    public void act(Government government) {
        ...
        // <<<<<<< HEAD
        // double absoluteBase =
        // government.isAdaptiveCapAdjustmentBasedOnCapNotActualEmissions() ?
        // government
        ...
        // for (PowerGeneratingTechnologyTarget target :
        // targetInvestor.getPowerGenerationTechnologyTargets()) {
        // double producedRenewableElectricityByTechnologyByTargetInvestor =
        ...
        // .isNaN(plannedProducedRenewableElectricityByTechnologyAndTargetInvestor)
        // ? 0
        // : plannedProducedRenewableElectricityByTechnologyAndTargetInvestor;
        // }
        // }
        //
        // double capReduction =
        // government.isAdaptiveCapAdjustmentRelativeToNonSubsidisedProduction()
        // ? calculateCapReductionForTimeStepRelativeToNonSubsidizedGeneration(
        // government, plannedProductionByRenewables,
        // totalProducedRenewableElectricity, totalProduction,
        // absoluteBase)
        // :
        ...
        // government.getCo2CapTrend().getValue(getCurrentTick()) -
        // capReduction);
        ...
        // co2CapAdjustmentTimeSeries.setTimeSeries(new
        // double[government.getCo2CapTrend().getTimeSeries().length]);
        ...
        // }
        //
        // public double calculatedExpectedCapReductionForTimeStep(Government
        // government, long currentTimeStep,
        // long futureTimeStep,
        // double currentEmissions,
        // double futureEmissions, long centralForecastingYear) {
        //
        // double co2Emissions = 1.0d / centralForecastingYear *
        // currentEmissions + (centralForecastingYear - 1.0d)
        // / centralForecastingYear * futureEmissions;
        //
        // double totalProduction = 0;
        //
        // for (ElectricitySpotMarket esm :
        // reps.marketRepository.findAllElectricitySpotMarkets()) {
        // for (ClearingPoint cp :
        // reps.clearingPointRepository.findAllClearingPointsForMarketAndTimeRange(esm,
        ...
        // totalProduction += cp.getVolume() * (centralForecastingYear - 1) /
        ...
        // double absoluteBase =
        // government.isAdaptiveCapAdjustmentBasedOnCapNotActualEmissions() ?
        // government.getCo2CapTrend().getValue(futureTimeStep - 1) :
        // co2Emissions;
        //
        // double plannedProductionByRenewables = 0;
        // double totalPlannedCapacity = 0;
        ...
        // producedRenewableElectricityByTechnologyByTargetInvestor;
        // double installedCapacityByTechnology = reps.powerPlantRepository
        // .calculateCapacityOfExpectedOperationalPowerPlantsByOwnerByTechnology(futureTimeStep
        // - 1,
        // targetInvestor, target.getPowerGeneratingTechnology());
        // totalActualInstalledCapacity += installedCapacityByTechnology;
        // double plannedCapacityByTechnologyAndTargetInvestor =
        // target.getTrend().getValue(futureTimeStep - 1);
        // totalPlannedCapacity += plannedCapacityByTechnologyAndTargetInvestor;
        // double
        // plannedProducedRenewableElectricityByTechnologyAndTargetInvestor =
        // plannedCapacityByTechnologyAndTargetInvestor
        ...
        // ? calculateCapReductionForTimeStepRelativeToNonSubsidizedGeneration(
        // government, plannedProductionByRenewables,
        // totalProducedRenewableElectricity, totalProduction,absoluteBase)
        // :
        // calculateCapReductionForTimeStepRelativeToTotalGeneration(government,
        // plannedProductionByRenewables, totalProducedRenewableElectricity,
        // totalProduction, absoluteBase);
        ...
        // calculateCapReductionForTimeStepRelativeToTotalGeneration(Government
        // government,
        // double plannedProductionByRenewables, double
        // totalProducedRenewableElectricity, double totalProduction,
        // double absoluteBase) {
        // double averageEmissionsPerMWh = (absoluteBase / totalProduction);
        // double plannedSavedEmissionsApproximation =
        // plannedProductionByRenewables * averageEmissionsPerMWh;
        // double actualSavedEmissionsApproximation =
        // totalProducedRenewableElectricity * averageEmissionsPerMWh;
        //
        // double capReduction = 0;
        //
        // if (!government.isDeviationFromResTargetAdjustment()) {
        // capReduction = actualSavedEmissionsApproximation *
        // government.getAdaptiveCapCO2SavingsWeighingFactor();
        // } else {
        // capReduction = Math.max(0, actualSavedEmissionsApproximation -
        ...
        //
        // double
        // calculateCapReductionForTimeStepRelativeToNonSubsidizedGeneration(Government
        // government,
        // double plannedProductionByRenewables, double
        // totalProducedRenewableElectricity, double totalProduction,
        // double absoluteBase) {
        // double capReduction = Math.max(0, (totalProducedRenewableElectricity
        // - plannedProductionByRenewables)
        ...
        // // plannedProductionByRenewables, totalProducedRenewableElectricity,
        // // totalProduction,absoluteBase);
        // // logger.warn("CapReductionToNonSub: {}, instead of to toal:
        // {}",capReduction,alternativeCapReduction);
        // =======
        double averageEmissionsPerMWh = government.isAdaptiveCapAdjustmentBasedOnCapNotActualEmissions()
                ? (government.getCo2CapTrend().getValue(getCurrentTick()) / totalProduction)
                : (co2Emissions / totalProduction);
    ...
    public double calculatedExpectedCapReductionForTimeStep(Government government, long currentTimeStep,
        ...
        double co2Emissions = 1.0d / centralForecastingYear * currentEmissions
                + (centralForecastingYear - 1.0d) / centralForecastingYear * futureEmissions;
        ...
        double averageEmissionsPerMWh = government.isAdaptiveCapAdjustmentBasedOnCapNotActualEmissions()
                ? (government.getCo2CapTrend().getValue(futureTimeStep - 1) / totalProduction)
                : (co2Emissions / totalProduction);
