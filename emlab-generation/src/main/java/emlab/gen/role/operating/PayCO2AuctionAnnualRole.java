 ...
 */
@RoleComponent
public class PayCO2AuctionAnnualRole extends AbstractEnergyProducerRole implements Role<EnergyProducer> {
    ...
    public void act(EnergyProducer producer) {
        ...
        for (PowerPlant plant : reps.powerPlantRepository.findOperationalPowerPlantsByOwner(producer,
                getCurrentTick())) {
            double money = calculateCO2MarketCostAnnual(plant, false, getCurrentTick());
        ...
        double co2Price = findCO2PriceOnAnnualMarket(getCurrentTick());
