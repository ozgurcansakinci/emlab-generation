...
public class Regulator extends DecarbonizationAgent implements Agent {
    ...
    public double getCrossBorderContractedCapacity() {
        return crossBorderContractedCapacity;
    }

    public void setCrossBorderContractedCapacity(double crossBorderContractedCapacity) {
        this.crossBorderContractedCapacity = crossBorderContractedCapacity;
    }
