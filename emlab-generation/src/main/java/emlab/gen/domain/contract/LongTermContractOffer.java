...
public class LongTermContractOffer {
    ...
    public String toString() {
        return "Offer of " + getSeller() + " for " + getUnderlyingPowerPlant() + " price " + getPrice() + " zone "
                + getZone() + " capacity " + getCapacity() + " type " + getLongTermContractType() + " start time "
                + getStart() + " duration " + getDuration() + " fuel price start " + getFuelPriceStart()
                + " fuel price pass " + getFuelPassThroughFactor() + " co2PriceStart " + getCo2PriceStart()
                + " co2 pass " + getCo2PassThroughFactor();
    }
}
