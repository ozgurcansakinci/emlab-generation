...
//
// @Query(value =
// "g.idx('__types__')[[className:'emlab.gen.domain.agent.TargetInvestor']].as('x').out('INVESTOR_MARKET').idFilter(market,
// FilterPipe.Filter.EQUAL).back('x')", type = QueryType.Gremlin)
// Iterable<TargetInvestor> findAllByMarket(@Param("market")
// ElectricitySpotMarket electricitySpotMarket);
// =======
